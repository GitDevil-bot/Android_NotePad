...
public final class NotePad {
    ...
    public static final class Notes implements BaseColumns {
        ...
        /**
         * The default sort order for this table (todos first, then by modification date)
         */
        public static final String DEFAULT_SORT_ORDER = "is_todo DESC, modified DESC";
